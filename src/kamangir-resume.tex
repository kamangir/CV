...
\section{Blogging}
\cvline{}{Arash started blogging in October 2004 in English under the pen name Kamangir (Archer). He started a Persian blog with the same name in May 2007. He now blogs at \url{http://kamangir.net}{kamangir.net}. English Kamangir was deactivated in 2012.}
...
Detailed list of publications available on \url{http://abadpour.com}{abadpour.com}.}
...
\cvline{}{More details about the activities of Arash Abadpour can be found on \url{http://abadpour.com}{abadpour.com}. Specifics on projects are available upon request and depending on sensitivity concerns.}
